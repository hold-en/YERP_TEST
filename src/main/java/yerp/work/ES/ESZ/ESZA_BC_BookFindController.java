...
@RestController
@RequestMapping("/ESZ")
public class ESZA_BC_BookFindController {
	@Autowired
	private CommonService commonService;
	
	@GetMapping("/ESZA_BC_Book_Find")
	public ResponseEntity<JSONObject> ESZA_BC_Book_Find(@CommonParam Map<String, Object> parameter) {
		JSONArray sqlResult = new JSONArray();
		APIResponse response = new APIResponse();
		try {
			String sqlMap = "";
			
			sqlMap = "ES.ESZ.ESZA_MP_Book_Find";
